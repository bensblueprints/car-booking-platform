  ...
  const fleet: Array<Omit<Prisma.CarCreateInput, 'tenant' | 'category' | 'location'> & { categorySlug: string }> = [
    {
      ...
      images: [img('photo-1502877338535-766e1452684a'), img('photo-1583121274602-3e2820c69888')],
      color: 'Silver',
    ...
    },
    {
      ...
      images: [img('photo-1503376780353-7e6692767b70'), img('photo-1568844293986-8d0400bd4745')],
      color: 'White',
    ...
    },
    {
      ...
      images: [img('photo-1617531653332-bd46c24f2068'), img('photo-1612825173281-9a193378527e')],
      color: 'Silver',
    ...
    },
    {
      ...
      images: [img('photo-1606611013016-969c19ba27bb'), img('photo-1533473359331-0135ef1b58bf')],
      color: 'Black',
    ...
    },
    {
      ...
      images: [img('photo-1494976388531-d1058494cdd8'), img('photo-1606611013016-969c19ba27bb')],
      color: 'White',
    ...
    },
    {
      ...
      images: [img('photo-1541899481282-d53bffe3c35d'), img('photo-1511919884226-fd3cad34687c')],
      color: 'Red',
